		                    ...
		                    <div className="bets-container flex center" data-id={gameData._id}>
		                        <div className="bets-away flex-vertical">
		                            ...
		                            <div className="vote-container flex">
		                                ...
		                                <div data-title='awayTeamSpread' data-vote-title="awayTeamSpreadVotes" data-id={gameData._id} className="vote" onClick={((e) => this.props.vote(e, gameData))}>{gameData.awayTeamSpread}</div>
		                            </div>
		                            <div className="vote-container flex">
		                                <div data-title="awayTeamMLVotes" className="vote-number center">{gameData.awayTeamMLVotes}</div>
		                                <div data-title='awayTeamML' data-vote-title="awayTeamMLVotes" data-id={gameData._id} className="vote" onClick={((e) => this.props.vote(e, gameData))}>{gameData.awayTeamML}</div>
		                            </div>
		                            <div className="vote-container flex">
		                                <div data-title="betOUUnderVotes" className="vote-number center">{gameData.betOUUnderVotes}</div>
		                                <div data-title='betOUUnder' data-vote-title="betOUUnderVotes" data-id={gameData._id} className="flex vote flex-center betOU" onClick={((e) => this.props.vote(e, gameData))}>
		                        ...
		                        <div className="bets-home flex-vertical">
		                            ...
		                            <div className="vote-container flex">
		                                <div data-title='homeTeamSpread' data-vote-title="homeTeamSpreadVotes" data-id={gameData._id} className="vote" onClick={((e) => this.props.vote(e, gameData))}>{gameData.homeTeamSpread}</div>
		                                <div data-title="homeTeamSpreadVotes" className="vote-number center">{gameData.homeTeamSpreadVotes}</div>
		                            </div>
		                            <div className="vote-container flex">
		                                <div data-title='homeTeamML' data-vote-title="homeTeamMLVotes" data-id={gameData._id} className="vote" onClick={((e) => this.props.vote(e, gameData))}>{gameData.homeTeamML}</div>
		                                <div data-title="homeTeamMLVotes" className="vote-number center">{gameData.homeTeamMLVotes}</div>
		                            </div>
		                            <div className="vote-container flex">
		                                <div data-title='betOUOver' data-vote-title="betOUOverVotes" data-id={gameData._id} className="flex vote flex-center betOU" onClick={((e) => this.props.vote(e, gameData))}>
		                                    <div data-title="betOU">{gameData.betOU}</div>
