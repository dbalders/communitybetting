			                    ...
			                    <div className="bets-container flex center" data-id={gameData._id}>
			                        <div className="bets-away flex-vertical">
			                            ...
			                            <div className="vote-container flex">
			                                ...
			                                <div data-title='betOUUnder' data-vote-title="betOUUnderVotes" data-id={gameData._id} className={`flex vote flex-center betOU ${(this.state.isVoted) ? 'vote-selected' : null}`} 
			                                	onClick={(e) => {
			                                		this.props.vote(e, gameData);
			                                		this.setState({ isVoted: !this.state.isVoted })
			                                	}}>
